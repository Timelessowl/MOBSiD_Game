...
urlpatterns = [
    ...
    path('set-timer', views.AppSetTimer.as_view(), name='set-timer'),
    path('get-timer', views.AppGetTimer.as_view(), name='get-timer'),
    path('get-current-question', views.TestGetQuestion.as_view(), name='get-current-question'),
    path('set-current-question', views.TestSetQuestion.as_view(), name='set-current-question'),
